  ...
  #exec_opcode(op) {
    ...
    switch (op) {
      ...
      case Op.CALLDATACOPY: {
        const raws0 = this.stack.pop()
        const mem_off = Number(toBigInt(raws0.data))

        const raws1 = this.stack.pop()
        const src_off = Number(toBigInt(raws1.data))
      ...
      case Op.CODESIZE:
        this.stack.push_uint(BigInt(this.code.length))
        return [2]
